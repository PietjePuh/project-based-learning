...
Track your learning journey through the project-based tutorials. Check off projects as you complete them and add notes about your experience.

> **Tip:** Fork this repo and edit this file to track your personal progress. Use [NOTES.md](NOTES.md) for detailed notes on each completed project.
...
- [ ] Tiny Renderer (OpenGL software rendering)
- [ ] Understandable RayTracing in 256 lines
- [ ] KABOOM! in 180 lines of C++
- [ ] 486 lines of C++: old-school FPS
...
- [ ] Meta Crush Saga: C++17 compile-time game
...
- [ ] Programming concurrent servers (Parts 1-6)
- [ ] MQTT Broker from scratch (Parts 1-6 + Bonus)

### C/C++ OpenGL

- [ ] Creating 2D Breakout game clone with OpenGL
- [ ] Handmade Hero
...
- [ ] Build iOS Photo Library App with Xamarin
- [ ] Building the CoreWiki

## Clojure

- [ ] Build a Twitter Bot with Clojure
- [ ] Building a Spell-Checker
- [ ] Building a JIRA integration with Clojure
...
- [ ] How to write a super fast link shortener with Elixir

## Erlang

- [ ] ChatBus: build your first multi-user chat room app
...
- [ ] Building Blockchain in Go (Parts 1-7)
- [ ] Building a container from scratch in Go
- [ ] Build Web Application with GoLang
- [ ] Building a Chat Application in Go with ReactJS (Parts 1-6)
- [ ] Go WebAssembly Tutorial - Building a Calculator
- [ ] REST Servers in Go (Parts 1-7)
- [ ] Let's build a URL shortener in Go (Parts 1-4)
...
- [ ] Build an Interpreter (Crafting Interpreters, Chapters 4-13)
...
- [ ] Build a Full Stack Movie Voting App
...
- [ ] Build A Random Quote Machine (Parts 1-7)
...
- [ ] Build a Google+ clone with Django and AngularJS
...
- [ ] Vue.js Application Tutorial - Budgeting App
- [ ] Build a Blog with Vue, GraphQL and Apollo
- [ ] Build a full stack web application using MEVN
- [ ] Vue.js To-Do List Tutorial
- [ ] Vue 2 + Pub/Sub: peer to peer multi-user platform
...
- [ ] How to Build a Web Framework in Less Than 20 Lines
...
- [ ] BYTEPATH: Complete Game with Lua and LOVE (Parts 0-15)
...
- [ ] Build A Real Estate Website with SilverStripe
- [ ] Building Realtime Chat App with Laravel 5.4 and VueJS
- [ ] Build A Social Network: Laravel 5
- [ ] Build a full-featured multi-tenant app with Laravel (Parts 0-7)
...
- [ ] Build a Community-driven delivery application with Django
...
- [ ] Learn Python For Data Science (Parts 1-6)
...
- [ ] Find Similar Quora Questions (BOW/TFIDF + Word2Vec)
...
- [ ] Build fastest custom object Detection (YOLOv3)
...
- [ ] Use pre-trained Inception model for image predictions
...
- [ ] Learn Twitter Sentiment Analysis (Parts I-XI)
- [ ] Use Transfer Learning for custom image classification
- [ ] Learn to Code a simple Neural Network in 11 lines
...
- [ ] Code a Smile Classifier using CNNS
...
- [ ] Writing a basic x86-64 JIT compiler in stock Python
- [ ] Making a low level (Linux) debugger
- [ ] Implementing a Search Engine (Parts 1-3)
...
- [ ] Build your own Redis (Parts 0-4)
...
- [ ] Create a simulation of evolution using neural network and genetic algorithm
